...
Modellen estimerer at populasjonsgjennomsnitlig utgangspunkt for multiple sets er 56,86 enheter (intercept), og 57,31 enheter for single sets (intercept + setssingle). Den forventede populasjonsøkningen fra pre til post i multiple sets er 32,47 enheter (timepost), på single sets er det 28,08 enheter (timepost + timepost:setssingle). 
