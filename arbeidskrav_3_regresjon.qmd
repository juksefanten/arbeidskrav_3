...
Modellen tar post og "multiple sets" gruppen som utgangspunkt i analysen. Dette vil si at gjennomsnittlig belastning til "Multiple sets" gruppen var 89,32 enheter ved post (intercept), pre var 32,47 enheter lavere enn post (timepre). "Single sets" gruppen hadde et utgangspunkt 3,94 enheter lavere enn "multiple sets" gruppen(setssingle). "Multiple sets" gruppen økte med 4,39 enheter mer enn "Single sets" gruppen(timepre:setssingle). Derfor kan modellen indikere at flere sett leder til større økning av styrke i populasjonen. Fordi en mixed model skiller mellom faste populasjonseffekter og tilfeldig individuell variasjon, kan vi tolke disse estimatene som forventede verdier i populasjonen – ikke bare i dette utvalget.
